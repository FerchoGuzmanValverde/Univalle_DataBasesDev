--------------------------------------------------------
-- Archivo creado  - miércoles-septiembre-11-2019   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Type PERSONA_T
--------------------------------------------------------

  CREATE OR REPLACE TYPE "BDDOREXAMEN"."PERSONA_T" AS OBJECT 
(
  ci VARCHAR2(13),
  nombre VARCHAR2(30),
  ...
  MEMBER FUNCTION ufcInformacion RETURN LONG

);
/
CREATE OR REPLACE TYPE BODY "BDDOREXAMEN"."PERSONA_T" 
AS
  ...
  AS
    res LONG;
  BEGIN
    res:='Nombre: ' || nombre || 'Apellidos: ' || apellidoPaterno || ' ' || apellidoMaterno || 'CI: ' || ci;
    RETURN res;
  END ufcInformacion;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "BDDOREXAMEN"."DEMO_CUST_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence DEMO_ORDER_ITEMS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BDDOREXAMEN"."DEMO_ORDER_ITEMS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence DEMO_ORD_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BDDOREXAMEN"."DEMO_ORD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 11 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence DEMO_PROD_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BDDOREXAMEN"."DEMO_PROD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence DEMO_USERS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BDDOREXAMEN"."DEMO_USERS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence EMPLEADO_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BDDOREXAMEN"."EMPLEADO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence ESTUDIANTE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BDDOREXAMEN"."ESTUDIANTE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Table APEX$_ACL
--------------------------------------------------------

  CREATE TABLE "BDDOREXAMEN"."APEX$_ACL" 
   (	"ID" NUMBER, 
	"WS_APP_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."APEX$_WS_FILES" 
   (	"ID" NUMBER, 
	"WS_APP_ID" NUMBER, 
	"DATA_GRID_ID" NUMBER, 
	"ROW_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."APEX$_WS_HISTORY" 
   (	"ROW_ID" NUMBER, 
	"WS_APP_ID" NUMBER, 
	"DATA_GRID_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."APEX$_WS_LINKS" 
   (	"ID" NUMBER, 
	"WS_APP_ID" NUMBER, 
	"DATA_GRID_ID" NUMBER, 
	"ROW_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."APEX$_WS_NOTES" 
   (	"ID" NUMBER, 
	"WS_APP_ID" NUMBER, 
	"DATA_GRID_ID" NUMBER, 
	"ROW_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."APEX$_WS_ROWS" 
   (	"ID" NUMBER, 
	"WS_APP_ID" NUMBER, 
	"DATA_GRID_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."APEX$_WS_TAGS" 
   (	"ID" NUMBER, 
	"WS_APP_ID" NUMBER, 
	"DATA_GRID_ID" NUMBER, 
	"ROW_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTION_HISTORY" 
   (	"SECTION_ID" NUMBER, 
	"WS_APP_ID" NUMBER, 
	"WEBPAGE_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" 
   (	"ID" NUMBER, 
	"WS_APP_ID" NUMBER, 
	"WEBPAGE_ID" NUMBER, 
	"DISPLAY_SEQUENCE" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."DEMO_CUSTOMERS" 
   (	"CUSTOMER_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."DEMO_ORDER_ITEMS" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."DEMO_ORDERS" 
   (	"ORDER_ID" NUMBER, 
	"CUSTOMER_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."DEMO_PRODUCT_INFO" 
   (	"PRODUCT_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."DEMO_STATES" 
   (	"ST" VARCHAR2(30 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."DEMO_USERS" 
   (	"USER_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."EMPLEADO" 
   (	"IDEMPLEADO" NUMBER(*,0), 
	"SALARIO" NUMBER(*,0), 
	"PERSONA" "BDDOREXAMEN"."PERSONA_T" 
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE TABLE "BDDOREXAMEN"."ESTUDIANTE" 
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
REM INSERTING into BDDOREXAMEN.APEX$_ACL
SET DEFINE OFF;
REM INSERTING into BDDOREXAMEN.APEX$_WS_FILES
SET DEFINE OFF;
REM INSERTING into BDDOREXAMEN.APEX$_WS_HISTORY
SET DEFINE OFF;
REM INSERTING into BDDOREXAMEN.APEX$_WS_LINKS
SET DEFINE OFF;
REM INSERTING into BDDOREXAMEN.APEX$_WS_NOTES
SET DEFINE OFF;
REM INSERTING into BDDOREXAMEN.APEX$_WS_ROWS
SET DEFINE OFF;
REM INSERTING into BDDOREXAMEN.APEX$_WS_TAGS
SET DEFINE OFF;
REM INSERTING into BDDOREXAMEN.APEX$_WS_WEBPG_SECTION_HISTORY
SET DEFINE OFF;
REM INSERTING into BDDOREXAMEN.APEX$_WS_WEBPG_SECTIONS
SET DEFINE OFF;
REM INSERTING into BDDOREXAMEN.DEMO_CUSTOMERS
SET DEFINE OFF;
Insert into BDDOREXAMEN.DEMO_CUSTOMERS (CUSTOMER_ID,CUST_FIRST_NAME,CUST_LAST_NAME,CUST_STREET_ADDRESS1,CUST_STREET_ADDRESS2,CUST_CITY,CUST_STATE,CUST_POSTAL_CODE,PHONE_NUMBER1,PHONE_NUMBER2,CREDIT_LIMIT,CUST_EMAIL) values ('1','John','Dulles','45020 Aviation Drive',null,'Sterling','VA','20166','703-555-2143',null,'1000',null);
...
REM INSERTING into BDDOREXAMEN.DEMO_ORDER_ITEMS
SET DEFINE OFF;
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('1','1','1','50','10');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('2','1','2','80','8');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('3','1','3','150','5');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('4','2','1','50','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('5','2','2','80','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('6','2','3','150','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('7','2','4','60','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('8','2','5','80','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('9','2','6','120','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('10','2','7','30','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('11','2','8','125','4');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('12','2','9','110','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('13','2','10','50','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('14','3','4','60','4');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('15','3','5','80','4');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('16','3','6','120','4');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('17','3','8','125','4');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('18','3','10','50','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('19','4','6','120','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('20','4','7','30','6');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('21','4','8','125','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('22','4','9','110','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('23','4','10','50','4');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('24','5','1','50','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('25','5','2','80','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('26','5','3','150','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('27','5','4','60','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('28','5','5','80','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('29','6','3','150','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('30','6','6','120','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('31','6','8','125','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('32','6','9','110','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('33','7','1','50','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('34','7','2','80','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('35','7','4','60','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('36','7','5','80','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('37','7','7','30','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('38','7','8','125','1');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('39','7','10','50','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('40','8','2','80','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('41','8','3','150','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('42','8','6','120','1');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('43','8','9','110','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('44','9','4','60','4');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('45','9','5','80','3');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('46','9','8','125','2');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('47','10','1','50','5');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('48','10','2','80','4');
Insert into BDDOREXAMEN.DEMO_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,UNIT_PRICE,QUANTITY) values ('49','10','3','150','2');
REM INSERTING into BDDOREXAMEN.DEMO_ORDERS
SET DEFINE OFF;
Insert into BDDOREXAMEN.DEMO_ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_TOTAL,ORDER_TIMESTAMP,USER_ID) values ('1','7','1890',to_date('10/09/19','DD/MM/RR'),'2');
Insert into BDDOREXAMEN.DEMO_ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_TOTAL,ORDER_TIMESTAMP,USER_ID) values ('2','1','2380',to_date('07/09/19','DD/MM/RR'),'2');
Insert into BDDOREXAMEN.DEMO_ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_TOTAL,ORDER_TIMESTAMP,USER_ID) values ('3','2','1640',to_date('01/09/19','DD/MM/RR'),'2');
Insert into BDDOREXAMEN.DEMO_ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_TOTAL,ORDER_TIMESTAMP,USER_ID) values ('4','5','1090',to_date('24/08/19','DD/MM/RR'),'2');
Insert into BDDOREXAMEN.DEMO_ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_TOTAL,ORDER_TIMESTAMP,USER_ID) values ('5','6','950',to_date('19/08/19','DD/MM/RR'),'2');
Insert into BDDOREXAMEN.DEMO_ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_TOTAL,ORDER_TIMESTAMP,USER_ID) values ('6','3','1515',to_date('14/08/19','DD/MM/RR'),'2');
Insert into BDDOREXAMEN.DEMO_ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_TOTAL,ORDER_TIMESTAMP,USER_ID) values ('7','3','905',to_date('04/08/19','DD/MM/RR'),'2');
Insert into BDDOREXAMEN.DEMO_ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_TOTAL,ORDER_TIMESTAMP,USER_ID) values ('8','4','1060',to_date('02/08/19','DD/MM/RR'),'2');
Insert into BDDOREXAMEN.DEMO_ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_TOTAL,ORDER_TIMESTAMP,USER_ID) values ('9','2','730',to_date('22/07/19','DD/MM/RR'),'2');
Insert into BDDOREXAMEN.DEMO_ORDERS (ORDER_ID,CUSTOMER_ID,ORDER_TOTAL,ORDER_TIMESTAMP,USER_ID) values ('10','7','870',to_date('08/07/19','DD/MM/RR'),'2');
REM INSERTING into BDDOREXAMEN.DEMO_PRODUCT_INFO
SET DEFINE OFF;
Insert into BDDOREXAMEN.DEMO_PRODUCT_INFO (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,CATEGORY,PRODUCT_AVAIL,LIST_PRICE,MIMETYPE,FILENAME,IMAGE_LAST_UPDATE) values ('1','Business Shirt','Wrinkle-free cotton business shirt','Mens','Y','50','image/jpeg','shirt.jpg',to_date('11/09/19','DD/MM/RR'));
Insert into BDDOREXAMEN.DEMO_PRODUCT_INFO (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,CATEGORY,PRODUCT_AVAIL,LIST_PRICE,MIMETYPE,FILENAME,IMAGE_LAST_UPDATE) values ('2','Trousers','Black trousers suitable for every business man','Mens','Y','80','image/jpeg','pants.jpg',to_date('11/09/19','DD/MM/RR'));
Insert into BDDOREXAMEN.DEMO_PRODUCT_INFO (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,CATEGORY,PRODUCT_AVAIL,LIST_PRICE,MIMETYPE,FILENAME,IMAGE_LAST_UPDATE) values ('3','Jacket','Fully lined jacket which is both professional and extremely comfortable to wear','Mens','Y','150','image/jpeg','jacket.jpg',to_date('11/09/19','DD/MM/RR'));
Insert into BDDOREXAMEN.DEMO_PRODUCT_INFO (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,CATEGORY,PRODUCT_AVAIL,LIST_PRICE,MIMETYPE,FILENAME,IMAGE_LAST_UPDATE) values ('4','Blouse','Silk blouse ideal for all business women','Womens','Y','60','image/jpeg','blouse.jpg',to_date('11/09/19','DD/MM/RR'));
Insert into BDDOREXAMEN.DEMO_PRODUCT_INFO (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,CATEGORY,PRODUCT_AVAIL,LIST_PRICE,MIMETYPE,FILENAME,IMAGE_LAST_UPDATE) values ('5','Skirt','Wrinkle free skirt','Womens','Y','80','image/jpeg','skirt.jpg',to_date('11/09/19','DD/MM/RR'));
Insert into BDDOREXAMEN.DEMO_PRODUCT_INFO (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,CATEGORY,PRODUCT_AVAIL,LIST_PRICE,MIMETYPE,FILENAME,IMAGE_LAST_UPDATE) values ('6','Ladies Shoes','Low heel and cushioned interior for comfort and style in simple yet elegant shoes','Womens','Y','120','image/jpeg','heels.jpg',to_date('11/09/19','DD/MM/RR'));
Insert into BDDOREXAMEN.DEMO_PRODUCT_INFO (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,CATEGORY,PRODUCT_AVAIL,LIST_PRICE,MIMETYPE,FILENAME,IMAGE_LAST_UPDATE) values ('7','Belt','Leather belt','Accessories','Y','30','image/jpeg','belt.jpg',to_date('11/09/19','DD/MM/RR'));
Insert into BDDOREXAMEN.DEMO_PRODUCT_INFO (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,CATEGORY,PRODUCT_AVAIL,LIST_PRICE,MIMETYPE,FILENAME,IMAGE_LAST_UPDATE) values ('8','Bag','Unisex bag suitable for carrying laptops with room for many additional items','Accessories','Y','125','image/jpeg','bag.jpg',to_date('11/09/19','DD/MM/RR'));
Insert into BDDOREXAMEN.DEMO_PRODUCT_INFO (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,CATEGORY,PRODUCT_AVAIL,LIST_PRICE,MIMETYPE,FILENAME,IMAGE_LAST_UPDATE) values ('9','Mens Shoes','Leather upper and lower lace up shoes','Mens','Y','110','image/jpeg','shoes.jpg',to_date('11/09/19','DD/MM/RR'));
Insert into BDDOREXAMEN.DEMO_PRODUCT_INFO (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,CATEGORY,PRODUCT_AVAIL,LIST_PRICE,MIMETYPE,FILENAME,IMAGE_LAST_UPDATE) values ('10','Wallet','Travel wallet suitable for men and women. Several compartments for credit cards, passports and cash','Accessories','Y','50','image/jpeg','wallet.jpg',to_date('11/09/19','DD/MM/RR'));
REM INSERTING into BDDOREXAMEN.DEMO_STATES
SET DEFINE OFF;
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('AK','ALASKA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('AL','ALABAMA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('AR','ARKANSAS');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('AZ','ARIZONA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('CA','CALIFORNIA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('CO','COLORADO');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('CT','CONNECTICUT');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('DC','DISTRICT OF COLUMBIA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('DE','DELAWARE');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('FL','FLORIDA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('GA','GEORGIA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('HI','HAWAII');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('IA','IOWA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('ID','IDAHO');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('IL','ILLINOIS');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('IN','INDIANA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('KS','KANSAS');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('KY','KENTUCKY');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('LA','LOUISIANA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('MA','MASSACHUSETTS');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('MD','MARYLAND');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('ME','MAINE');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('MI','MICHIGAN');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('MN','MINNESOTA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('MO','MISSOURI');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('MS','MISSISSIPPI');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('MT','MONTANA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('NC','NORTH CAROLINA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('ND','NORTH DAKOTA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('NE','NEBRASKA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('NH','NEW HAMPSHIRE');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('NJ','NEW JERSEY');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('NM','NEW MEXICO');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('NV','NEVADA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('NY','NEW YORK');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('OH','OHIO');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('OK','OKLAHOMA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('OR','OREGON');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('PA','PENNSYLVANIA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('RI','RHODE ISLAND');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('SC','SOUTH CAROLINA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('SD','SOUTH DAKOTA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('TN','TENNESSEE');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('TX','TEXAS');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('UT','UTAH');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('VA','VIRGINIA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('VT','VERMONT');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('WA','WASHINGTON');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('WI','WISCONSIN');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('WV','WEST VIRGINIA');
Insert into BDDOREXAMEN.DEMO_STATES (ST,STATE_NAME) values ('WY','WYOMING');
REM INSERTING into BDDOREXAMEN.DEMO_USERS
SET DEFINE OFF;
Insert into BDDOREXAMEN.DEMO_USERS (USER_ID,USER_NAME,PASSWORD,CREATED_ON,QUOTA,PRODUCTS,EXPIRES_ON,ADMIN_USER) values ('1','ADMIN','065C8A5D6D4BC43E7D29E729CB9BED76',to_date('11/09/19','DD/MM/RR'),null,'Y',null,'Y');
Insert into BDDOREXAMEN.DEMO_USERS (USER_ID,USER_NAME,PASSWORD,CREATED_ON,QUOTA,PRODUCTS,EXPIRES_ON,ADMIN_USER) values ('2','DEMO','DE39CFD02AA723289752619BFF16A372',to_date('11/09/19','DD/MM/RR'),'15000','Y',null,'N');
REM INSERTING into BDDOREXAMEN.DEPT
SET DEFINE OFF;
Insert into BDDOREXAMEN.DEPT (DEPTNO,DNAME,LOC) values ('10','ACCOUNTING','NEW YORK');
Insert into BDDOREXAMEN.DEPT (DEPTNO,DNAME,LOC) values ('20','RESEARCH','DALLAS');
Insert into BDDOREXAMEN.DEPT (DEPTNO,DNAME,LOC) values ('30','SALES','CHICAGO');
Insert into BDDOREXAMEN.DEPT (DEPTNO,DNAME,LOC) values ('40','OPERATIONS','BOSTON');
REM INSERTING into BDDOREXAMEN.EMP
SET DEFINE OFF;
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7839','KING','PRESIDENT',null,to_date('17/11/81','DD/MM/RR'),'5000',null,'10');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7698','BLAKE','MANAGER','7839',to_date('01/05/81','DD/MM/RR'),'2850',null,'30');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7782','CLARK','MANAGER','7839',to_date('09/06/81','DD/MM/RR'),'2450',null,'10');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7566','JONES','MANAGER','7839',to_date('02/04/81','DD/MM/RR'),'2975',null,'20');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7788','SCOTT','ANALYST','7566',to_date('09/12/82','DD/MM/RR'),'3000',null,'20');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7902','FORD','ANALYST','7566',to_date('03/12/81','DD/MM/RR'),'3000',null,'20');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7369','SMITH','CLERK','7902',to_date('17/12/80','DD/MM/RR'),'800',null,'20');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7499','ALLEN','SALESMAN','7698',to_date('20/02/81','DD/MM/RR'),'1600','300','30');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7521','WARD','SALESMAN','7698',to_date('22/02/81','DD/MM/RR'),'1250','500','30');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7654','MARTIN','SALESMAN','7698',to_date('28/09/81','DD/MM/RR'),'1250','1400','30');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7844','TURNER','SALESMAN','7698',to_date('08/09/81','DD/MM/RR'),'1500','0','30');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7876','ADAMS','CLERK','7788',to_date('12/01/83','DD/MM/RR'),'1100',null,'20');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7900','JAMES','CLERK','7698',to_date('03/12/81','DD/MM/RR'),'950',null,'30');
Insert into BDDOREXAMEN.EMP (EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO) values ('7934','MILLER','CLERK','7782',to_date('23/01/82','DD/MM/RR'),'1300',null,'10');
REM INSERTING into BDDOREXAMEN.EMPLEADO
SET DEFINE OFF;
REM INSERTING into BDDOREXAMEN.ESTUDIANTE
SET DEFINE OFF;
Insert into BDDOREXAMEN.ESTUDIANTE (IDESTUDIANTE,CARRERA,PERSONA) values ('2','Arquitectura',BDDOREXAMEN.PERSONA_T('123','FER','fer','FER','2019-09-02 00:00:00.0'));
Insert into BDDOREXAMEN.ESTUDIANTE (IDESTUDIANTE,CARRERA,PERSONA) values ('1','Sistemas',BDDOREXAMEN.PERSONA_T('123','fer','fer','fer','2019-07-02 00:00:00.0'));
--------------------------------------------------------
--  DDL for Index APEX$_WS_LINKS_IDX2
--------------------------------------------------------

  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_LINKS_IDX2" ON "BDDOREXAMEN"."APEX$_WS_LINKS" ("WS_APP_ID", "WEBPAGE_ID") 
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_FILES_IDX2" ON "BDDOREXAMEN"."APEX$_WS_FILES" ("WS_APP_ID", "WEBPAGE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."DEMO_ORD_CUSTOMER_IX" ON "BDDOREXAMEN"."DEMO_ORDERS" ("CUSTOMER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."DEMO_CUSTOMERS_PK" ON "BDDOREXAMEN"."DEMO_CUSTOMERS" ("CUSTOMER_ID") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."DEMO_PRODUCT_INFO_PK" ON "BDDOREXAMEN"."DEMO_PRODUCT_INFO" ("PRODUCT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."APEX$_ACL_PK" ON "BDDOREXAMEN"."APEX$_ACL" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."DEMO_USERS_PK" ON "BDDOREXAMEN"."DEMO_USERS" ("USER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_ACL_IDX1" ON "BDDOREXAMEN"."APEX$_ACL" ("WS_APP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."APEX$_WS_FILES_PK" ON "BDDOREXAMEN"."APEX$_WS_FILES" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."APEX$_WS_TAGS_PK" ON "BDDOREXAMEN"."APEX$_WS_TAGS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_FILES_IDX1" ON "BDDOREXAMEN"."APEX$_WS_FILES" ("WS_APP_ID", "DATA_GRID_ID", "ROW_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."DEMO_ORDER_ITEMS_PK" ON "BDDOREXAMEN"."DEMO_ORDER_ITEMS" ("ORDER_ITEM_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."EMPLEADO_PK" ON "BDDOREXAMEN"."EMPLEADO" ("IDEMPLEADO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_WEBPG_SECHIST_IDX1" ON "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTION_HISTORY" ("WS_APP_ID", "WEBPAGE_ID", "SECTION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_ROWS_IDX" ON "BDDOREXAMEN"."APEX$_WS_ROWS" ("WS_APP_ID", "DATA_GRID_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."DEMO_CUST_NAME_IX" ON "BDDOREXAMEN"."DEMO_CUSTOMERS" ("CUST_LAST_NAME", "CUST_FIRST_NAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."APEX$_WS_ROWS_PK" ON "BDDOREXAMEN"."APEX$_WS_ROWS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."APEX$_WS_LINKS_PK" ON "BDDOREXAMEN"."APEX$_WS_LINKS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_NOTES_IDX2" ON "BDDOREXAMEN"."APEX$_WS_NOTES" ("WS_APP_ID", "WEBPAGE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS_PK" ON "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."DEMO_ORDER_PK" ON "BDDOREXAMEN"."DEMO_ORDERS" ("ORDER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_HISTORY_IDX" ON "BDDOREXAMEN"."APEX$_WS_HISTORY" ("WS_APP_ID", "DATA_GRID_ID", "ROW_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."APEX$_WS_NOTES_PK" ON "BDDOREXAMEN"."APEX$_WS_NOTES" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_TAGS_IDX2" ON "BDDOREXAMEN"."APEX$_WS_TAGS" ("WS_APP_ID", "WEBPAGE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_NOTES_IDX1" ON "BDDOREXAMEN"."APEX$_WS_NOTES" ("WS_APP_ID", "DATA_GRID_ID", "ROW_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_TAGS_IDX1" ON "BDDOREXAMEN"."APEX$_WS_TAGS" ("WS_APP_ID", "DATA_GRID_ID", "ROW_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE INDEX "BDDOREXAMEN"."APEX$_WS_LINKS_IDX1" ON "BDDOREXAMEN"."APEX$_WS_LINKS" ("WS_APP_ID", "DATA_GRID_ID", "ROW_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BDDOREXAMEN"."ESTUDIANTE_PK" ON "BDDOREXAMEN"."ESTUDIANTE" ("IDESTUDIANTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_LINKS" ADD CONSTRAINT "APEX$_WS_LINKS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_LINKS" ADD CONSTRAINT "APEX$_WS_LINKS_SH_CK" CHECK (show_on_homepage in ('Y','N')) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_LINKS" ADD CONSTRAINT "APEX$_WS_LINKS_CL_CK" CHECK (component_level in ('WEBSHEET','ROW','WORKSPACE','WEBPAGE')) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_LINKS" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_LINKS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_LINKS" MODIFY ("URL" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_LINKS" MODIFY ("LINK_NAME" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_LINKS" MODIFY ("WS_APP_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table ESTUDIANTE
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."ESTUDIANTE" ADD CONSTRAINT "ESTUDIANTE_PK" PRIMARY KEY ("IDESTUDIANTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."ESTUDIANTE" MODIFY ("CARRERA" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."ESTUDIANTE" MODIFY ("IDESTUDIANTE" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DEMO_USERS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."DEMO_USERS" ADD CONSTRAINT "DEMO_USERS_PK" PRIMARY KEY ("USER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_HISTORY" MODIFY ("DATA_GRID_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_HISTORY" MODIFY ("WS_APP_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_HISTORY" MODIFY ("ROW_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table APEX$_WS_TAGS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_TAGS" ADD CONSTRAINT "APEX$_WS_TAGS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_TAGS" ADD CONSTRAINT "APEX$_WS_TAGS_CL_CK" CHECK (component_level in ('WEBSHEET','ROW','WORKSPACE','WEBPAGE')) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_TAGS" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_TAGS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_TAGS" MODIFY ("WS_APP_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table APEX$_WS_ROWS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_ROWS" ADD CONSTRAINT "APEX$_WS_ROWS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_ROWS" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_ROWS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_ROWS" MODIFY ("DATA_GRID_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_ROWS" MODIFY ("WS_APP_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_ROWS" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table APEX$_ACL
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."APEX$_ACL" ADD CONSTRAINT "APEX$_ACL_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_ACL" ADD CONSTRAINT "APEX$_ACL_PRIV_CK" CHECK (priv in ('R','C','A')) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_ACL" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_ACL" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_ACL" MODIFY ("PRIV" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_ACL" MODIFY ("USERNAME" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_ACL" MODIFY ("WS_APP_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_ACL" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table APEX$_WS_WEBPG_SECTION_HISTORY
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTION_HISTORY" MODIFY ("CHANGE_DATE" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTION_HISTORY" MODIFY ("APPLICATION_USER_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTION_HISTORY" MODIFY ("WEBPAGE_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTION_HISTORY" MODIFY ("WS_APP_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTION_HISTORY" MODIFY ("SECTION_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table APEX$_WS_FILES
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_FILES" ADD CONSTRAINT "APEX$_WS_FILES_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_FILES" ADD CONSTRAINT "APEX$_WS_FILES_CL_CK" CHECK (component_level in ('WEBSHEET','ROW','WORKSPACE','WEBPAGE')) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_FILES" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_FILES" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_FILES" MODIFY ("MIME_TYPE" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_FILES" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_FILES" MODIFY ("WS_APP_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DEMO_ORDERS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDERS" ADD CONSTRAINT "DEMO_ORDER_PK" PRIMARY KEY ("ORDER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDERS" ADD CONSTRAINT "DEMO_ORDER_TOTAL_MIN" CHECK (order_total >= 0) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDERS" MODIFY ("CUSTOMER_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDERS" MODIFY ("ORDER_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table APEX$_WS_NOTES
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_NOTES" ADD CONSTRAINT "APEX$_WS_NOTES_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_NOTES" ADD CONSTRAINT "APEX$_WS_NOTES_CL_CK" CHECK (component_level in ('WEBSHEET','ROW','WORKSPACE','WEBPAGE')) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_NOTES" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_NOTES" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_NOTES" MODIFY ("WS_APP_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DEMO_CUSTOMERS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."DEMO_CUSTOMERS" ADD CONSTRAINT "DEMO_CUSTOMERS_PK" PRIMARY KEY ("CUSTOMER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."DEMO_CUSTOMERS" ADD CONSTRAINT "DEMO_CUST_CREDIT_LIMIT_MAX" CHECK (credit_limit <= 5000) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."DEMO_CUSTOMERS" MODIFY ("CUST_LAST_NAME" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."DEMO_CUSTOMERS" MODIFY ("CUST_FIRST_NAME" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."DEMO_CUSTOMERS" MODIFY ("CUSTOMER_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DEMO_PRODUCT_INFO
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."DEMO_PRODUCT_INFO" ADD CONSTRAINT "DEMO_PRODUCT_INFO_PK" PRIMARY KEY ("PRODUCT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."DEMO_PRODUCT_INFO" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DEMO_ORDER_ITEMS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDER_ITEMS" ADD CONSTRAINT "DEMO_ORDER_ITEMS_PK" PRIMARY KEY ("ORDER_ITEM_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDER_ITEMS" MODIFY ("QUANTITY" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDER_ITEMS" MODIFY ("UNIT_PRICE" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDER_ITEMS" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDER_ITEMS" MODIFY ("ORDER_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDER_ITEMS" MODIFY ("ORDER_ITEM_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table EMPLEADO
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."EMPLEADO" ADD CONSTRAINT "EMPLEADO_PK" PRIMARY KEY ("IDEMPLEADO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."EMPLEADO" MODIFY ("SALARIO" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."EMPLEADO" MODIFY ("IDEMPLEADO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table APEX$_WS_WEBPG_SECTIONS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" ADD CONSTRAINT "APEX$_WS_WEBPG_SECTIONS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" ADD CONSTRAINT "APEX$_WS_WEBPG_SECTION_3D_CK" CHECK (chart_3d in ('Y','N')) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" ADD CONSTRAINT "APEX$_WS_WEBPG_SECTION_LINK_CK" CHECK (nav_include_link in ('Y','N')) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" ADD CONSTRAINT "APEX$_WS_WEBPG_SECTION_TYPE_CK" CHECK (section_type in ('TEXT','DATA','CHART','NAV_PAGE','NAV_SECTION')) ENABLE;
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" MODIFY ("SECTION_TYPE" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" MODIFY ("WS_APP_ID" NOT NULL ENABLE);
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table EMP
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."EMP" ADD PRIMARY KEY ("EMPNO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BDDOREXAMEN"."EMP" MODIFY ("EMPNO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DEPT
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."DEPT" ADD PRIMARY KEY ("DEPTNO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_FILES" ADD CONSTRAINT "APEX$_WS_FILES_FK" FOREIGN KEY ("ROW_ID")
	  REFERENCES "BDDOREXAMEN"."APEX$_WS_ROWS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table APEX$_WS_LINKS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_LINKS" ADD CONSTRAINT "APEX$_WS_LINKS_FK" FOREIGN KEY ("ROW_ID")
	  REFERENCES "BDDOREXAMEN"."APEX$_WS_ROWS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table APEX$_WS_NOTES
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_NOTES" ADD CONSTRAINT "APEX$_WS_NOTES_FK" FOREIGN KEY ("ROW_ID")
	  REFERENCES "BDDOREXAMEN"."APEX$_WS_ROWS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table APEX$_WS_TAGS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."APEX$_WS_TAGS" ADD CONSTRAINT "APEX$_WS_TAGS_FK" FOREIGN KEY ("ROW_ID")
	  REFERENCES "BDDOREXAMEN"."APEX$_WS_ROWS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DEMO_ORDER_ITEMS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDER_ITEMS" ADD CONSTRAINT "DEMO_ORDER_ITEMS_FK" FOREIGN KEY ("ORDER_ID")
	  REFERENCES "BDDOREXAMEN"."DEMO_ORDERS" ("ORDER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDER_ITEMS" ADD CONSTRAINT "DEMO_ORDER_ITEMS_PRODUCT_ID_FK" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "BDDOREXAMEN"."DEMO_PRODUCT_INFO" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DEMO_ORDERS
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDERS" ADD CONSTRAINT "DEMO_ORDERS_CUSTOMER_ID_FK" FOREIGN KEY ("CUSTOMER_ID")
	  REFERENCES "BDDOREXAMEN"."DEMO_CUSTOMERS" ("CUSTOMER_ID") ENABLE;
  ALTER TABLE "BDDOREXAMEN"."DEMO_ORDERS" ADD CONSTRAINT "DEMO_ORDERS_USER_ID_FK" FOREIGN KEY ("USER_ID")
	  REFERENCES "BDDOREXAMEN"."DEMO_USERS" ("USER_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EMP
--------------------------------------------------------

  ALTER TABLE "BDDOREXAMEN"."EMP" ADD FOREIGN KEY ("MGR")
	  REFERENCES "BDDOREXAMEN"."EMP" ("EMPNO") ENABLE;
  ALTER TABLE "BDDOREXAMEN"."EMP" ADD FOREIGN KEY ("DEPTNO")
	  REFERENCES "BDDOREXAMEN"."DEPT" ("DEPTNO") ENABLE;
--------------------------------------------------------
--  DDL for Trigger APEX$_ACL_T1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."APEX$_ACL_T1" 
...
/
ALTER TRIGGER "BDDOREXAMEN"."APEX$_ACL_T1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger APEX$_WS_FILES_T1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."APEX$_WS_FILES_T1" 
...
/
ALTER TRIGGER "BDDOREXAMEN"."APEX$_WS_FILES_T1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger APEX$_WS_LINKS_T1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."APEX$_WS_LINKS_T1" 
...
/
ALTER TRIGGER "BDDOREXAMEN"."APEX$_WS_LINKS_T1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger APEX$_WS_NOTES_T1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."APEX$_WS_NOTES_T1" 
...
/
ALTER TRIGGER "BDDOREXAMEN"."APEX$_WS_NOTES_T1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger APEX$_WS_ROWS_T1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."APEX$_WS_ROWS_T1" 
...
/
ALTER TRIGGER "BDDOREXAMEN"."APEX$_WS_ROWS_T1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger APEX$_WS_TAGS_T1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."APEX$_WS_TAGS_T1" 
...
/
ALTER TRIGGER "BDDOREXAMEN"."APEX$_WS_TAGS_T1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger APEX$_WS_WEBPG_SECTIONS_T1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS_T1" 
...
/
ALTER TRIGGER "BDDOREXAMEN"."APEX$_WS_WEBPG_SECTIONS_T1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger BI_DEMO_USERS
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."BI_DEMO_USERS" 
BEFORE
...
/
ALTER TRIGGER "BDDOREXAMEN"."BI_DEMO_USERS" ENABLE;
--------------------------------------------------------
--  DDL for Trigger DEMO_ORDER_ITEMS_GET_PRICE
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."DEMO_ORDER_ITEMS_GET_PRICE" 
...
/
ALTER TRIGGER "BDDOREXAMEN"."DEMO_ORDER_ITEMS_GET_PRICE" ENABLE;
--------------------------------------------------------
--  DDL for Trigger DEMO_USERS_T1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."DEMO_USERS_T1" 
BEFORE
...
/
ALTER TRIGGER "BDDOREXAMEN"."DEMO_USERS_T1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger EMPLEADO_DIS
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."EMPLEADO_DIS" 
   before insert on "BDDOREXAMEN"."EMPLEADO" 
   for each row 
begin  
   if inserting then 
      if :NEW."IDEMPLEADO" is null then 
         select EMPLEADO_SEQ.nextval into :NEW."IDEMPLEADO" from dual; 
      end if; 
   end if; 
end;

/
ALTER TRIGGER "BDDOREXAMEN"."EMPLEADO_DIS" ENABLE;
--------------------------------------------------------
--  DDL for Trigger ESTUDIANTE_DIS
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."ESTUDIANTE_DIS" 
   before insert on "BDDOREXAMEN"."ESTUDIANTE" 
   for each row 
begin  
   if inserting then 
...
/
ALTER TRIGGER "BDDOREXAMEN"."ESTUDIANTE_DIS" ENABLE;
--------------------------------------------------------
--  DDL for Trigger INSERT_DEMO_CUST
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."INSERT_DEMO_CUST" 
...
END;
/
ALTER TRIGGER "BDDOREXAMEN"."INSERT_DEMO_CUST" ENABLE;
--------------------------------------------------------
--  DDL for Trigger INSERT_DEMO_ORDER_ITEMS
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."INSERT_DEMO_ORDER_ITEMS" 
BEFORE
...
/
ALTER TRIGGER "BDDOREXAMEN"."INSERT_DEMO_ORDER_ITEMS" ENABLE;
--------------------------------------------------------
--  DDL for Trigger INSERT_DEMO_PROD
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."INSERT_DEMO_PROD" 
...
END;
/
ALTER TRIGGER "BDDOREXAMEN"."INSERT_DEMO_PROD" ENABLE;
--------------------------------------------------------
--  DDL for Trigger UPDATE_ORDER_TOTAL
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BDDOREXAMEN"."UPDATE_ORDER_TOTAL" 
...
/
ALTER TRIGGER "BDDOREXAMEN"."UPDATE_ORDER_TOTAL" ENABLE;
--------------------------------------------------------
--  DDL for Function CUSTOM_AUTH
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "BDDOREXAMEN"."CUSTOM_AUTH" (p_username in VARCHAR2, p_password in VARCHAR2)
return BOOLEAN
is
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "BDDOREXAMEN"."CUSTOM_HASH" (p_username in varchar2, p_password in varchar2)
return varchar2
is
  l_password varchar2(4000);
  l_salt varchar2(4000) := 'N2FKADM1V43PBWKWR9VYF7OMH4W2SL';
begin
