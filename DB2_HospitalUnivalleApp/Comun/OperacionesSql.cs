...
namespace Univalle.Fie.Sistemas.BaseDeDatos2.HospitalApp.Comun
{
    ...
    public class OperacionesSql
    {
        ...
        public static string _connectionString = ConfigurationManager.ConnectionStrings["Univalle.Fie.Sistemas.BaseDeDatos2.HospitalApp.EmpleadosDal.Properties.Settings.HospitalUnivalle2019ConnectionString"].ConnectionString;
