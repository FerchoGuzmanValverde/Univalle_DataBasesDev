...
namespace Ferale.SistemaDeInformacionApp.SIFComun
{
    ...
    public class OperacionesSql
    {
        ...
        public static string _connectionString = ConfigurationManager.ConnectionStrings["Ferale.SistemaDeInformacionApp.SIFComun.Properties.Settings.dbFeraleConnectionString"].ConnectionString;
